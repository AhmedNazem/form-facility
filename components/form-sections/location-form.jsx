...
export default function LocationForm({ form, language }) {
  const translations = {
    ...
    mapUrlDesc: language === "en" ? "Share your Google Maps location link" : "شارك رابط موقعك على خرائط جوجل",
    landmark: language === "en" ? "Nearest Landmark" : "أقرب معلم",
    landmarkDesc:
      language === "en" ? "Mention a well-known place near your facility" : "اذكر مكانًا معروفًا بالقرب من منشأتك",
      ...
      <CardContent className="pt-6">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder={language === "en" ? "Enter country" : "أدخل الدولة"} {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder={language === "en" ? "Enter city" : "أدخل المدينة"} {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder={language === "en" ? "Enter district" : "أدخل الحي"} {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder={language === "en" ? "Enter street" : "أدخل الشارع"} {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="md:col-span-2">
                ...
                <FormControl>
                  <Input placeholder={language === "en" ? "Enter nearest landmark" : "أدخل أقرب معلم"} {...field} />
                </FormControl>
          ...
          <div className="md:col-span-2">
            <h4 className="text-sm font-medium mb-2">{translations.coordinates}</h4>
